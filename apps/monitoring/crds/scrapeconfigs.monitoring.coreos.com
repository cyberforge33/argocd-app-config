            ...
            properties:
              ...
              ionosSDConfigs:
                ...
                items:
                  ...
                  properties:
                    authorization:
                      description: Authorization` header configuration, required when
                        using IONOS.
                      properties:
                        credentials:
                          description: Selects a key of a Secret in the namespace
                    ...
                    enableHTTP2:
                      ...
                      type: boolean
                    followRedirects:
                      description: Configure whether the HTTP requests should follow
                        HTTP 3xx redirects.
                      type: boolean
                    noProxy:
                      description: |-
                    ...
                    refreshInterval:
                      ...
                      type: string
                    tlsConfig:
                      description: TLS configuration to use when connecting to the
                        IONOS API.
                      properties:
                        ca:
                          description: Certificate authority used when verifying server
                ...
                items:
                  ...
                  properties:
                    ...
                    region:
                      ...
                      type: string
                    tagSeparator:
                      description: The string by which Linode Instance tags are joined
                        into the tag label.
                      minLength: 1
                      type: string
                    tlsConfig:
                  ...
                  properties:
                    ...
                    service:
                      ...
                      - enum:
                        - VPS
                        - DedicatedServer
                      description: Service of the targets to retrieve. Must be `VPS`
                        or `DedicatedServer`.
                      type: string
                  required:
                  - applicationKey
...
status:
  acceptedNames:
    ...
    singular: scrapeconfig
  conditions:
  - lastTransitionTime: "2025-05-19T20:39:15Z"
